package mk.finki.ukim.mk.lab3.web.servlet;
...
public class EventListSevlet extends HttpServlet {
    private final mk.finki.ukim.mk.lab3.service.EventService EventService;
    ...
    public EventListSevlet(mk.finki.ukim.mk.lab3.service.EventService eventService, EventBookingService bookings, SpringTemplateEngine engine) {
